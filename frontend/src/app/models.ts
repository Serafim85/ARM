...
export type WorkstationMetricSeries = {
  metricKey: string;
  displayName: string;
  unit: string;
  points: WorkstationMetricPoint[];
};

export type WorkstationMetricsHistory = {
  deviceKey: string;
  from: string;
  to: string;
...
export type WorkstationLogEntry = {
  recordedAt: string;
  level: string;
  message: string;
  source: string | null;
...
export type WorkstationEventEntry = {
  id: number;
  recordedAt: string;
  eventType: string;
  severity: string;
