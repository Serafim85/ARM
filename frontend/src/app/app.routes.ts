...
import { WorkstationsPageComponent } from './pages/workstations-page/workstations-page.component';
import { WorkstationCardPageComponent } from './pages/workstations-page/workstation-card-page.component';
...
const networkScannerRoutes: Routes = environment.hideNetworkScannerFeatures
  ? []
  : [
...
const armDefaultRoute = environment.hideNetworkScannerFeatures ? 'workstations' : 'scan';
    ...
    children: [
      {
        path: '',
        pathMatch: 'full',
        redirectTo: armDefaultRoute,
      },
      ...networkScannerRoutes,
      {
        path: 'monitoring/:id',
      ...
      { path: 'workstations', component: WorkstationsPageComponent },
      { path: 'workstations/:id', component: WorkstationCardPageComponent },
